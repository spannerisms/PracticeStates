...
;===================================================================================================
%menu_header("Defeat Arrghus", 1)
	%submenu("Arrghus", presetmenu_defeatarrghus_arrghus)
...
;---------------------------------------------------------------------------------------------------
;===================================================================================================
presetmenu_defeatarrghus_arrghus:
%menu_header("Arrghus", 19)
...
%write8($7E0CFB, $0A) ; Rupee pull kills
..end
;-----------------------------
.leaving_sanctuary
%write8($7E044A, $02) ; EG strength
...
%write8($7E0CFB, $10) ; Rupee pull kills
..end
;-----------------------------
.arrghus
%write8($7E0CFC, $08) ; Rupee pull hits
..end
