...
;===================================================================================================
%menu_header("Defeat Trinexx", 1)
	%submenu("Trinexx", presetmenu_defeattrinexx_trinexx)
...
;---------------------------------------------------------------------------------------------------
;===================================================================================================
presetmenu_defeattrinexx_trinexx:
%menu_header("Trinexx", 24)
...
;-----------------------------
.fire_rod_stc
%write8($7E02A2, $03) ; Slot 4 Altitude
%write8($7E0FCA, $01) ; Prize pack 3
...
.ice_chair_1
%write8($7E044A, $01) ; EG strength
%write8($7E0CFB, $07) ; Rupee pull kills
..end
;-----------------------------
...
;-----------------------------
.tr_entrance
%write8($7E0CFB, $08) ; Rupee pull kills
..end
;-----------------------------
.trinexx
%write8($7E0FCD, $01) ; Prize pack 6
%write8($7E0CFB, $09) ; Rupee pull kills
%write8($7E0CFC, $06) ; Rupee pull hits
..end
