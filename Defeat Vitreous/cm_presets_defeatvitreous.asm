...
;===================================================================================================
%menu_header("Defeat Vitreous", 1)
	%submenu("Vitreous", presetmenu_defeatvitreous_vitreous)
...
;---------------------------------------------------------------------------------------------------
;===================================================================================================
presetmenu_defeatvitreous_vitreous:
%menu_header("Vitreous", 17)
...
;---------------------------------------------------------------------------------------------------
%preset_UW("Green YBA", "defeatvitreous", "vitreous", "green_yba")
dw $0001 ; Screen ID
...
;---------------------------------------------------------------------------------------------------
%preset_UW("Plaid World", "defeatvitreous", "vitreous", "plaid_world")
dw $0052 ; Screen ID
dw $04F8, $0BE1 ; Link Coords
dw $0480, $0B10 ; Camera HV
db $0B ; Item
db $02 ; Direction
;-----------------------------
db $26 ; Entrance
...
;-----------------------------
.vitreous
%write8($7E02A2, $D1) ; Slot 4 Altitude
..end
